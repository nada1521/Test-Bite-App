...
part of 'item_details_response_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ItemDetailsResponseModel _$ItemDetailsResponseModelFromJson(
        Map<String, dynamic> json) =>
    ItemDetailsResponseModel(
      meals: (json['meals'] as List<dynamic>)
          .map((e) => ItemDetailsModel.fromJson(e as Map<String, dynamic>))
          .toList(),
    );

Map<String, dynamic> _$ItemDetailsResponseModelToJson(
        ItemDetailsResponseModel instance) =>
    <String, dynamic>{
